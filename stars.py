...
from vpython import mag2
from vpython import sphere

from vpython import random
...
G = 1.7e-10  # Universal gravitational constant
...
for i in range(Nstars):
    star = sphere(pos=L*vec.random(), make_trail=True,
                  retain=150, trail_radius=2e8)
...
while True:
    ...
    while hit > 0:
        ...
        s1.color = s1.trail_color = (
            s1.mass*s1.color + s2.mass*s2.color) / mass
